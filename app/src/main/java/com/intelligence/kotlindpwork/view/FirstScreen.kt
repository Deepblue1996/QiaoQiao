...
import com.intelligence.kotlindpwork.databinding.ActivityMainBinding
 ...
 */
class FirstScreen : BaseScreenKt<ActivityMainBinding>() {
...
//        })
        ...
        Dove.flyLife(CoreApp.jobTask.getPictureCategory(),
            object : Dover<DataExt<Categories>>() {
                ...
                override fun don(p0: Disposable?, p1: DataExt<Categories>) {
                    ...
                    here.drawerLayoutRecyclerView.adapter!!.notifyDataSetChanged()
                }
        ...
        Dove.flyLife(CoreApp.jobTask.getPictureByCategory(
            ...
            object : Dover<DataExt<CategoryPicture>>() {
                ...
                override fun don(p0: Disposable?, p1: DataExt<CategoryPicture>) {
                    ...
                    here.recyclerView.adapter!!.notifyDataSetChanged()
                    finishRefreshLoadMore()
                }
            })
    }
    ...
    private fun finishRefreshLoadMore() {
        if (homeListState == -1) {
            here.refreshLayout.finishRefresh(0)
        } else {
            here.refreshLayout.finishLoadMore(0)
        }
        homeListState = 0
    }
